...
<title>UPDATE KAMAR FARHAN</title>
...
$query=mysqli_query($koneksi,"SELECT * from kamar where id_kamar='$id_kamar'"); $row=mysqli_fetch_array($query);
?>
<div class="box-login">
        <form action="proses_update_kamar.php" method="post">
        <div class="container">
  <div class="box-login">
  <h4 align="center">UPDATE KAMAR</h4>
  <hr>
  ...
  <form action="" method="post">
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        #C0C0C0;" readonly value="<?php echo $row['id_kamar']; ?>" name="id_kamar">
    </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" value="<?php echo $row['jenis_kamar']; ?>" name="jenis_kamar">
    </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" value="<?php echo $row['deskripsi']; ?>" name="deskripsi">
    </div>
    </div>
